/**
 * Brutalist Mentor Discovery
 * Clean, focused, no-bullshit mentor finding
 */
...
export default function MentorsScreen() {
  ...
  const renderMentorCard = ({ item: mentor }: { item: MentorProfile }) => {
  ...
  const handleMentorSelection = (mentor: MentorProfile) => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
        ...
        <View style={styles.searchSection}>
          <View style={[styles.searchContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <TextInput
              ...
              placeholder="search by experience, university, or vibe..."
          ...
          <View style={[styles.requestButtonContainer, { backgroundColor: colors.background }]}>
            ...
            >
              <Text style={styles.requestButtonText}>
                Request {selectedMentors.length} Selected Wizzmo{selectedMentors.length === 1 ? '' : 's'}
              </Text>
        ...
        <View style={[styles.modalContainer, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.proUpgradeContent}>
            ...
            <Text style={[styles.proDescription, { color: colors.textSecondary }]}>
              Get access to advanced filtering by mentor ratings and experience levels to find the perfect Wizzmo for your needs.
            </Text>
