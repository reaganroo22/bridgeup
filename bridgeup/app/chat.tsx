            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (item.sender_id === session?.mentor_id) {
                  ...
                  router.push(`/bridgeup-profile?userId=${session.mentor_id}`);
                } else if (item.sender_id === session?.student_id) {
    ...
    >
      ...
      {showAttachmentMenu && session.status === 'active' && (
        <View style={[styles.attachmentMenu, { backgroundColor: colors.surface, borderTopColor: colors.separator }]}>
          ...
          >
            <View style={[styles.attachmentIconContainer, { backgroundColor: CURRENT_VERTICAL.primaryColor }]}>
          ...
          >
            <View style={[styles.attachmentIconContainer, { backgroundColor: CURRENT_VERTICAL.accentColor }]}>
