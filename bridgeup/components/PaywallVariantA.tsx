...
export default function PaywallVariantA({ visible, onClose }: PaywallVariantAProps) {
  ...
  const [selectedPlan, setSelectedPlan] = useState<SubscriptionPlan>('pro_monthly'); // Default to monthly
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            ...
            <View style={styles.pricingSection}>
              <TouchableOpacity
                style={[styles.pricingCard, selectedPlan === 'pro_monthly' && styles.selectedCard]}
                onPress={() => {
              ...
              <TouchableOpacity
                style={[styles.pricingCard, styles.premiumCard, selectedPlan === 'pro_yearly' && styles.selectedCard]}
                onPress={() => {
