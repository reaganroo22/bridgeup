# RevenueCat Implementation Documentation - BridgeUp App

## Overview

The BridgeUp Expo app implements RevenueCat for subscription management using `react-native-purchases` v9.6.4. This implementation handles subscription tiers, paywall management, and usage tracking for a college advice app.
...
- **Monthly**: `$rc_monthly` → `com.bridgeupapp.app.pro_monthly`
- **Annual**: `$rc_annual` → `com.bridgeupapp.app.pro_annual`
