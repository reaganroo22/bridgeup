  ...
  const getStatusMessage = () => {
    if (!application) {
      return {
        ...
        message: "Wizzmo couldn't find a mentor application for your account. Please contact support if you believe this is an error."
      };
    }
    ...
    switch (application.application_status) {
      case 'pending':
        return {
          ...
          message: "Wizzmo is carefully reviewing your mentor application! We'll notify you via email once a decision has been made. This usually takes 1-2 business days."
        };
      case 'rejected':
        return {
          title: "Application Not Approved",
          message: "Unfortunately, your mentor application was not approved at this time. You're still welcome to use Wizzmo as a student! Check your email for more details."
        };
      default:
        return {
          title: "Application Status Unknown",
          message: "Wizzmo is having trouble determining your application status. Please contact support for assistance."
        };
    }
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          <Image
            source={require('@/assets/images/wizzmo.png')}
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.supportText}>
            Need help? Contact us at support@wizzmo.app
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
