...
export default function BecomeAWizzmoPage() {
  ...
  return (
    <div className="min-h-screen bg-white lg:bg-gray-50 overflow-x-hidden">
      <div className="lg:grid lg:grid-cols-2 min-h-screen max-h-screen lg:max-h-none overflow-y-auto lg:overflow-visible">
        ...
        {/* Right Side - Form */}
        <div className="flex flex-col justify-center px-6 py-8 lg:py-12 lg:px-8 max-h-screen overflow-y-auto lg:overflow-visible">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <label className="text-sm text-gray-700">
                    I am a <strong>woman</strong> currently at or recently graduated from Georgetown.
                  </label>
                </div>
