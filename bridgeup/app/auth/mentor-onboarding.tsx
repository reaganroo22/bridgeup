...
const bearImages = {
  'happy': require('@/assets/images/bridgeup-logo.png'),
  'interested': require('@/assets/images/bridgeup-logo.png'),
  'stargazed': require('@/assets/images/bridgeup-logo.png'),
  'glow': require('@/assets/images/bridgeup-logo.png'),
  'sleepy': require('@/assets/images/bridgeup-logo.png'),
  'glowing': require('@/assets/images/bridgeup-logo.png'),
  'bridgeup': require('@/assets/images/bridgeup-logo.png'),
};
...
export default function MentorOnboarding() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: 'I just became a mentor on BridgeUp! 🐻 Join me in helping college students with dating, relationships & life advice.',
  ...
  const renderWelcome = () => (
    <View style={styles.stepContent}>
      ...
      <Text style={styles.welcomeTitle}>become a bridgeup mentor!</Text>
  ...
  const renderUsername = () => (
    <View style={styles.stepContent}>
      ...
      <View style={styles.inputGroup}>
        ...
        <Text style={styles.inputSubtitle}>this will be your unique handle on bridgeup</Text>
  ...
  const renderSuccess = () => (
    <View style={styles.stepContent}>
      ...
      <View>
        <Text style={styles.completionTitle}>you're a bridgeup mentor!</Text>
