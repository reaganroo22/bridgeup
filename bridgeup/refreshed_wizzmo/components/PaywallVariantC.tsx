          ...
          <View style={styles.content}>
            ...
            <View style={styles.quickSection}>
              <TouchableOpacity
                ...
                onPress={() => handlePurchase('wizzmo_monthly')}
                disabled={isPurchasing}
              >
                {isPurchasing && selectedPlan === 'wizzmo_monthly' ? (
              ...
              <TouchableOpacity
                ...
                onPress={() => handlePurchase('wizzmo_annual')}
                disabled={isPurchasing}
              >
                {isPurchasing && selectedPlan === 'wizzmo_annual' ? (
