...
export const SubscriptionProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateSubscriptionStatusFromCustomerInfo = (customerInfo: CustomerInfo) => {
    ...
    const hasMonthly = customerInfo.activeSubscriptions.includes('com.wizzmo.app.pro_monthly');
    const hasAnnual = customerInfo.activeSubscriptions.includes('com.wizzmo.app.pro_annual');
