...
interface NotificationContextType {
  ...
  // BridgeUp-specific notification workflows
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
      ...
      const messagesChannel = supabase
        ...
        .on(
          ...
          (payload) => {
            ...
            scheduleLocalNotification(
              'New Message',
              'You have a new message from your college advisor',
              {
                type: 'new_message',
        ...
        .on(
          ...
          (payload) => {
            if (payload.new.status === 'matched') {
              ...
              scheduleLocalNotification(
                'Question Matched!',
                'Your question has been matched with an advisor',
                {
  ...
  const notifyMentorsOfNewQuestionFlow = async (
    ...
    try {
      ...
      console.log('[NotificationContext] Advisors notified of new question:', questionId);
    } catch (error) {
      console.error('[NotificationContext] Error notifying advisors:', error);
    }
  };
