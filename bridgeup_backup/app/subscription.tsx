        ...
        >
          ...
          <Animated.View style={{ opacity: fadeAnim1, transform: [{ translateY: slideAnim1 }] }}>
            <View style={[styles.statusCard, { backgroundColor: colors.surfaceElevated, borderColor: colors.border }]}>
              <LinearGradient
                colors={isProUser() ? CURRENT_VERTICAL.gradientColors : ['#71717A', '#3F3F46']}
              ...
              {!isProUser() && (
                <TouchableOpacity style={styles.upgradeButton} onPress={handleUpgrade}>
                  <LinearGradient colors={CURRENT_VERTICAL.gradientColors} style={styles.upgradeGradient}>
              ...
              {subscriptionStatus.plan === 'pro_monthly' ? (
                <View style={[styles.savingsCard, { backgroundColor: colors.surfaceElevated, borderColor: colors.primary }]}>
                  ...
                  <TouchableOpacity style={styles.changePlanButton} onPress={handleUpgrade}>
                    <LinearGradient colors={colors.gradientPrimary as unknown as readonly [string, string, ...string[]]} style={styles.changePlanGradient}>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  {expandedFAQ === index && (
                    <Animated.View
                      style={[
                        { opacity: fadeAnim6, transform: [{ translateY: slideAnim6 }] },
                        styles.faqAnswer, 
