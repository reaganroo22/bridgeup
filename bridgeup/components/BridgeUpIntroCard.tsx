...
interface BridgeUpIntroCardProps {
  visible: boolean;
  onClose: () => void;
  mentor: {
    id: string;
...
export default function BridgeUpIntroCard({ visible, onClose, mentor }: BridgeUpIntroCardProps) {
          ...
          <View style={[styles.connectionCard, { backgroundColor: colors.surfaceElevated, borderColor: colors.border }]}>
            <View style={[styles.connectionHeader, { backgroundColor: 'transparent' }]}>
              ...
              <Text style={[styles.connectionTitle, { color: colors.text }]}>
                ready to get college prep advice!
              </Text>
            </View>
            <Text style={[styles.connectionText, { color: colors.textSecondary }]}>
              {mentor.full_name.split(' ')[0]} has accepted your question and is ready to help with college prep. 
              Feel free to ask about admissions, essays, SAT/ACT prep, or any other college readiness topics!
            </Text>
          </View>
        </ScrollView>
